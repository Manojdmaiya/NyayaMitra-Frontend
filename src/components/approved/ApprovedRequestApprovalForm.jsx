...
const ApprovedRequestApprovalForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://nyayamitra-backend-dev.onrender.com/api/approved/v1/request-approval", {
        method: "POST",
        headers: {
            ...
            <div className="card-body text-black">
              ...
              <div className="text-center mt-4">
                <p className="text-muted">
                  ...
                  <a href="/approved/contact" className="text-primary fw-semibold">contact us</a>.
                </p>
              </div>
            </div>
          </div>
...
export default ApprovedRequestApprovalForm;
